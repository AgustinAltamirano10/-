...
import java.util.LinkedList; // importo paquetespara usar listas
...
public class LinkedLists {
    public static void main(String[] args) {
        ...
        List<Persona> lista = new LinkedList<Persona>(); // Declaracion de la lista a utiliza
        ...
        Persona person4 = new Persona(5, "jorge", 78);

        // Agregar a la cabeza
        lista.add(0, person4); // el cero indica que es el principio de la lista (por salida deberia salir primero)

        // Agrego un elemento a la lista del tipo Persona
        lista.add(person); 
        lista.add(person1);
        lista.add(person2);
        lista.add(person3);
